...
$subscriptions = Get-AzSubscription | Out-GridView -Title "Select Subscriptions to search for v1 StorageAccounts" -PassThru 
...
$StorageAccounts = $StorageAccounts | Where-Object -Property Kind -EQ "Storage" | Out-GridView -Title "Select v1 Storage Accounts to upgrade" -PassThru
